...
export const biddingLabelStyle: React.CSSProperties = {
  fontSize: '13px',
  fontWeight: 600,
  opacity: 0.75,
};
export const biddingWrapRowStyle: React.CSSProperties = {
  display: 'flex',
  gap: '8px',
  flexWrap: 'wrap',
...
export const chipStyle = (active: boolean, disabled = false): React.CSSProperties => ({
  padding: '8px 12px',
  borderRadius: '999px',
  border: disabled ? '1px solid #e5e7eb' : active ? '1px solid #2563eb' : '1px solid #d1d5db',
