...
export const lobbyTitleStyle: React.CSSProperties = {
  margin: '0 0 6px 0',
  fontSize: 'clamp(1.35rem, 4vw, 1.75rem)',
  fontWeight: 700,
};
export const lobbySubtitleStyle: React.CSSProperties = {
  margin: 0,
  opacity: 0.85,
  fontSize: '15px',
  lineHeight: 1.45,
...
export const lobbySectionTitleStyle: React.CSSProperties = {
  margin: '0 0 12px 0',
  fontSize: '1.05rem',
  fontWeight: 600,
  opacity: 0.95,
...
export const lobbyListStyle: React.CSSProperties = {
  listStyle: 'none',
  margin: 0,
  padding: 0,
  display: 'flex',
...
export const lobbyPlayerCountStyle: React.CSSProperties = {
  fontWeight: 600,
  fontSize: '15px',
  marginBottom: '4px',
};
export const lobbyPlayerNamesStyle: React.CSSProperties = {
  fontSize: '13px',
  opacity: 0.8,
  overflow: 'hidden',
